...
typedef ModifiedMatrixGestureDetectorCallback = void Function(
    Matrix4 matrix,
    Matrix4 translationDeltaMatrix,
    Matrix4 scaleDeltaMatrix,
    Matrix4 rotationDeltaMatrix);

/// [ModifiedMatrixGestureDetector] detects translation, scale and rotation gestures
...
/// parameters.
///
class ModifiedMatrixGestureDetector extends StatefulWidget {
  /// [Matrix4] change notification callback
  ///
  final ModifiedMatrixGestureDetectorCallback onMatrixUpdate;
  ...
  /// Hit Behavior of [GestureDetector]
  ///
  ///
  ...
  const ModifiedMatrixGestureDetector({
    Key key,
  ...
  @override
  _ModifiedMatrixGestureDetectorState createState() => _ModifiedMatrixGestureDetectorState();
...
class _ModifiedMatrixGestureDetectorState extends State<ModifiedMatrixGestureDetector> {
